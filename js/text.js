...
function startTime() {
    ...
    if(myDate.getHours()<12){
      ...
      document.body.style.backgroundImage = "url('img/timeofday/city-sunset-sunrise-lens-flare.jpg')";
      ...
      document.body.style.backgroundImage = "url('img/timeofday/pexels-photo-30360.jpg')";
      document.getElementById('a1').style.color = "white";
      document.getElementById('a2').style.color = "white";
      ...
      document.body.style.backgroundImage = "url('img/timeofday/pexels-photo-24114.jpg')";
      document.getElementById('a1').style.color = "white";
      document.getElementById('a2').style.color = "white";
      document.getElementById("morning").style.display = "none";
      document.getElementById("afternoon").style.display = "none";
